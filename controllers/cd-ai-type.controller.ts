...
export class CdAiTypeController {
  ...
  async Create(req, res) {
    try {
      ...
      await this.b.serviceErr(req, res, e, "CdAiTypeTypeController:Create");
    }
  }
  ...
  //     try {
  //         await this.svCdAiTypeType.getCdAiTypeTypeTypeCount(req, res);
  //     } catch (e) {
  //         this.b.serviceErr(req, res, e, 'CdAiTypeTypeController:Get');
  //     }
  // }
  ...
  async GetCount(req, res) {
    try {
      await this.svCdAiTypeType.getCdAiTypeTypeCount(req, res);
    } catch (e) {
      await this.b.serviceErr(req, res, e, "CdAiTypeTypeController:Get");
    }
  }
  ...
  async Update(req, res) {
    console.log("CdAiTypeTypeController::Update()/01");
    try {
      console.log("CdAiTypeTypeController::Update()/02");
      await this.svCdAiTypeType.update(req, res);
    } catch (e) {
      await this.b.serviceErr(req, res, e, "CdAiTypeTypeController:Update");
    }
  }
