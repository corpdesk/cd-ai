...
export class CdAiController {
  ...
  async GetType(req: any, res: any) {
    try {
      ...
      await this.svCdAi.getType(req, res);
    } catch (e) {
      await this.b.serviceErr(req, res, e, "CdAiController:Get");
    }
  }
  ...
  async GetCount(req: any, res: any) {
    try {
      await this.svCdAi.getCount(req, res);
    } catch (e) {
  ...
  async GetPaged(req: any, res: any) {
    try {
      await this.svCdAi.getPaged(req, res);
    } catch (e) {
      await this.b.serviceErr(req, res, e, "CdAiController:GetPaged");
    }
  }
