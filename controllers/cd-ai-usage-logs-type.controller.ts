...
export class CdAiUsageLogsTypeController {
  ...
  async Create(req, res) {
    try {
      ...
      await this.b.serviceErr(
        ...
        res,
        e,
        "CdAiUsageLogsTypeTypeController:Create",
      );
    }
  }
  ...
  //     try {
  //         await this.svCdAiUsageLogsTypeType.getCdAiUsageLogsTypeTypeTypeCount(req, res);
  //     } catch (e) {
  //         this.b.serviceErr(req, res, e, 'CdAiUsageLogsTypeTypeController:Get');
  //     }
  // }
  ...
  async GetCount(req, res) {
    try {
      await this.svCdAiUsageLogsTypeType.getCdAiUsageLogsTypeTypeCount(
        req,
        res,
      );
    } catch (e) {
      await this.b.serviceErr(
        ...
        res,
        e,
        "CdAiUsageLogsTypeTypeController:Get",
      );
    }
  }
  ...
  async Update(req, res) {
    console.log("CdAiUsageLogsTypeTypeController::Update()/01");
    try {
      console.log("CdAiUsageLogsTypeTypeController::Update()/02");
      ...
      await this.b.serviceErr(
        ...
        res,
        e,
        "CdAiUsageLogsTypeTypeController:Update",
      );
    }
  }
