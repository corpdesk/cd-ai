...
export class CdAiUsageLogsTypeController {
  private b: BaseService<CdAiUsageLogsTypeModel>;
  ...
  async Get(req, res) {
    try {
      await this.svCdAiUsageLogsType.getType(req, res);
    } catch (e) {
  ...
  async GetCount(req, res) {
    try {
      await this.svCdAiUsageLogsType.getCount(req, res);
    } catch (e) {
      await this.b.serviceErr(
        req,
        res,
  ...
  async GetPaged(req: Request, res: Response): Promise<void> {
    try {
      await this.svCdAiUsageLogsType.getPaged(req, res);
    } catch (e) {
