...
@ViewEntity({
  ...
  expression: `
          SELECT 
            cd_ai_view.cd_ai_view_id AS cd_ai_view_id,
            cd_ai_view.cd_ai_view_guid AS cd_ai_view_guid,
            cd_ai_view.cd_ai_view_name AS cd_ai_view_name,
            cd_ai_view.cd_ai_view_description AS cd_ai_view_description,
