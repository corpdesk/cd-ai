...
export class CdAiUsageLogsTypeService {
  ...
  // <<cd:method:getCdAiUsageLogsTypeCount:start>>
  /**
   *
   * @param req
   * @param res
   */
  getCdAiUsageLogsTypeCount(req: any, res: any) {
    const q = this.b.getQuery(req);
    this.logger.logInfo(
      "CdAiUsageLogsTypeService::getCdAiUsageLogsTypeCount/q:",
      q,
    );
    const serviceInput = {
      serviceModel: CdAiUsageLogsViewModel,
      docName: "CdAiUsageLogsTypeService::getCdAiUsageLogsTypeCount$",
      cmd: {
        action: "find",
        query: q,
      },
  ...
  // <<cd:method:getCdAiUsageLogsTypeCount:end>>
  ...
  async getCdAiUsageLogsType(req, res, q?: IQuery): Promise<any> {
    ...
    this.logger.logInfo("CdAiUsageLogsTypeService::getCdAiUsageLogsTypef:", q);
    const serviceInput = this.b.siGet(
      q,
      "CdAiUsageLogsTypeService::getCdAiUsageLogsTypef",
