...
export class CdAiService {
  ...
  async get(req, res, q?: IQuery): Promise<any> {
    ...
    this.serviceModel = new CdAiModel();
    const serviceInput: IServiceInput<CdAiModel> = this.b.serviceInputGet(
      q,
      `CdAiService:getCdAi`,
      CdAiModel,
    );
  ...
  getCount(req, res) {
    ...
    console.log("CdAiService::getCount/q:", q);
    const serviceInput = {
      serviceModel: CdAiModel,
      docName: "CdAiService::getCount$",
      cmd: {
        action: "find",
        query: q,
      },
    ...
    this.b.readCount$(req, res, serviceInput).subscribe((r) => {
      this.b.i.code = "CdAiService::getCount";
      const svSess = new SessionService();
  ...
  getPaged(req, res) {
    ...
    this.b.readCount$(req, res, serviceInput).subscribe((r) => {
      this.b.i.code = "CdAiService::getPaged";
      const svSess = new SessionService();
      svSess.sessResp.cd_token = req.post.dat.token;
      svSess.sessResp.ttl = svSess.getTtl();
      this.b.setAppState(true, this.b.i, svSess.sessResp);
  ...
  getType(req, res) {
    ...
    try {
      this.b.read$(req, res, serviceInput).subscribe((r) => {
        ...
        this.b.i.code = "CdAiController::getType";
        const svSess = new SessionService();
        svSess.sessResp.cd_token = req.post.dat.token;
        svSess.sessResp.ttl = svSess.getTtl();
        this.b.setAppState(true, this.b.i, svSess.sessResp);
